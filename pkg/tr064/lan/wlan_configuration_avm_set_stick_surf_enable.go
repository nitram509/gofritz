...
// XavmSetStickSurfEnable AUTO-GENERATED (do not edit) code from [wlanconfigSCPD],
// based on SOAP action 'X_AVM-DE_SetStickSurfEnable', Fritz!Box-System-Version 164.07.57
//
// [wlanconfigSCPD]: http://fritz.box:49000/wlanconfigSCPD.xml
func XavmSetStickSurfEnable(session *soap.SoapSession, stickSurfEnable bool) (tr064model.XavmSetStickSurfEnableResponse, error) {
