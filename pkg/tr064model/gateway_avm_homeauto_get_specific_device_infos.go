...
// GetSpecificDeviceInfosResponse AUTO-GENERATED (do not edit) model from [x_homeautoSCPD],
// based on SOAP action 'GetSpecificDeviceInfos', Fritz!Box-System-Version 141.07.57
//
